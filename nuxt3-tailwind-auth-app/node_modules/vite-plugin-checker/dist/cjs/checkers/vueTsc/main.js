...
const createDiagnostic = (pluginConfig) => {
  ...
  return {
    ...
    async configureServer({ root }) {
      ...
      const vueTs = _require(import_path.default.resolve(targetTsDir, "lib/typescript.js"));
      ...
      const reportWatchStatusChanged = (diagnostic, newLine, options, errorCount) => {
        ...
        (0, import_logger.ensureCall)(() => {
          ...
          if (terminal) {
            logChunk = logChunk + import_os.default.EOL + (0, import_logger.wrapCheckerSummary)("vue-tsc", diagnostic.messageText.toString());
            if (logChunk === prevLogChunk) {
              return;
            }
            prevLogChunk = logChunk;
            (0, import_logger.consoleLog)(logChunk);
          }
        });
      };
